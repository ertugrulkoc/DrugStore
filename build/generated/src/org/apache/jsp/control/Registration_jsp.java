  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (application) {
        user = (beans.User) _jspx_page_context.getAttribute("user", PageContext.APPLICATION_SCOPE);
        if (user == null){
          user = new beans.User();
      ...
      out.write("    ");
        ...
        if (submit.equals("Register")) {
            ...
            boolean isSuccess = RegisterDao.register(user);
            if (isSuccess) {
      out.write("\n");
      out.write("                ");
      if (true) {
        _jspx_page_context.forward("drugspage.html");
        return;
      }
      out.write("\n");
      out.write("            ");
