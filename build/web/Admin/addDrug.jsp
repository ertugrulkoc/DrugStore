        ...
        <%
          ...
          try{
            ...
            if (drugname != null && price != null && info !=null && stock !=null ) {
                    boolean isSuccess = DrugDao.checkDrug(drugid);
                    if(!isSuccess){
            ...
            <div class="clearfix">
                <div class="main">
                    ...
                    <form action="addDrug.jsp" method="post" class="message">
                        ...
                        <label>Drug ID:  </label>
                        <input type="text" name="drugid"  placeholder="Drug ID" onclick=" this.value = ''">
                        ...
                        <label>Statu: </label>
                        <input type="text" name="statu"  placeholder="Statu" onclick=" this.value = ''"/>
